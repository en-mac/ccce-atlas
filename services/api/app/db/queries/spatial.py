...
All spatial queries use PostGIS geography type for accurate
distance calculations on the Earth's surface (spherical math).
"""
...
# Find parcel at a specific point (intersection check)
PARCEL_AT_POINT = """
SELECT
    id,
    parcel_id,
